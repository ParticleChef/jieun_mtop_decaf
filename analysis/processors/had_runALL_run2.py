...
class AnalysisProcessor(processor.ProcessorABC):
    ...
    def process(self, events):
        ...
        if ("preVFP" in dataset) and (self._year == '2016'):
            ...
            get_deepflav_weight = self._correctionsBtag['get_btag_weight_postVFP']['deepflav'][self._year]
...
#            genIsoAs = gen[gen.isIsoA & (gen.pt > 100)]
            ...
            btag['sr'], btagUp['sr'], btagDown['sr'] = get_deepflav_weight['loose'](j_iso, 
                    j_iso["T"]["pt"], 
                    j_iso.eta, 
                    j_iso.hadronFlavour, 
                    str(0), )
...
if __name__ == '__main__':
    ...
    #correctionsBtag = load('data/correctionsB.coffea')
    correctionsBtag = load('data/corrections_rishabh.coffea')
