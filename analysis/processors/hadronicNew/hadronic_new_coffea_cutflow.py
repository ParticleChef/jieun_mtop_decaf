...
#                    tmp = True
#            if tmp: tmp_count = tmp_count+1
#            #print('jet id', fj.Jet_jetId[i], fj.Jet_jetId[i]&6, (fj.Jet_jetId[i]&6)==6)
#        print("Number of less than 6 ID events: ", tmp_count)
...
if __name__ == '__main__':
    ...
    save(processor_instance, 'data/UL_had_ttag_cutflow_'+options.year+'_New_v3.processor')
    print("processor name: UL_had_ttag_cutflow_{}_New_v3".format(options.year))
