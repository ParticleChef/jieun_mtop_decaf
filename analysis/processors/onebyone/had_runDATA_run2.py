...
class AnalysisProcessor(processor.ProcessorABC):
    ...
    def process(self, events):
        ...
        mete_j = ak.cartesian({"mete": corrected_met, "j": j_good_clean})
        metm_j = ak.cartesian({"metm": corrected_met, "j": j_good_clean})
...
#                    'noextrab', 'noHEMj', 'noHEMmet'
            ...
            'wmcr': [ 
                    ...
                    'iszeroG',
                    'one_loose_mu', 'one_tight_mu', 'no_loose_e',
                    #'isoneM', 'iszeroG',
                    'fatjet_leading', 'recoil_wmcr', 'dPhi_recoil_fj_m', 'dPhi_recoil_j_m', 
                    'mt_wmcr',
                    'noHEMj',
                    'noextrab'
                    ],
...
#                    'oneE', 'noM',
                    'fatjet_leading',# 'recoil_wecr', 'dPhi_recoil_j_e', 'dPhi_recoil_fj_e', 'met100',
#                    'noextrab','noHEMj'
                    ],

            'tmcr': [
                    'met_filters' , 'met_triggers',
                    'no_loose_e','one_loose_mu', 'one_tight_mu',
                    'no_loose_pho',
                    'one_clean_j',
                    #'iszeroG',
                    #'isoneM', 'iszeroG',
                    'fatjet_leading','recoil_tmcr', 'dPhi_recoil_fj_m', 'dPhi_recoil_j_m', 
                    'mt_tmcr',
                    'noHEMj',
#                    'oneb'
                    ],
...
#    correctionsBtag = load('data/correction_btag.coffea')
 ...
 #                                          correctionsBtag=correctionsBtag,
    ...
    save(processor_instance, 'data/runDATA_'+options.year+'_Run'+options.run+'.processor')
    print("processor name: runDATA_{}_Run{}".format(options.year,options.run))
