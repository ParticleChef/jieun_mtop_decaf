    ...
    def __init__(self, year, xsec,corrections,  correctionsUL, ids, common, vfp):
        ...
        self._accumulator = processor.dict_accumulator({
            ...
            'partWpt': hist.Hist(
                ...
                hist.Cat('region', 'Region'),
                hist.Cat('systematic', 'Systematic'),
                hist.Bin('partWpt', 'particle W $p_T$ [GeV]', 30, 0., 800)
            ),
            'TvsQCD': hist.Hist(
                'Events',
                hist.Cat('dataset', 'Dataset'),
...
###########################################
        ...
        regions = {
            ...
            'zmcr': [
                    'met_filters' , 'met_triggers', 'istwoM', 
                    'one_ak4', 'one_ak15',
                    'leading_fj250',
                    'recoil_zmcr', 
                    'dPhi_recoil_fj_m', 'dPhi_recoil_j_m', 
            ...
            'zecr': [
                    'met_filters' , 'single_electron_triggers','istwoE',
                    'one_ak4', 'one_ak15',
                    'leading_fj250',
                    'recoil_zecr', 
                    'dPhi_recoil_fj_e', 'dPhi_recoil_j_e', 
        ...
        for region, cuts in regions.items():
            ...
            if region == 'gcr' or region == 'zecr' or region == 'zmcr' or region == 'sr':
                continue
            ...
            variables = {
                ...
                'partWpt':              gen[gen.hasFlags(['fromHardProcess', 'isFirstCopy', 'isPrompt']) & ((abs(gen.pdgId) == 24))].pt,
