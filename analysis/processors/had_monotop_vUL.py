...
class AnalysisProcessor(processor.ProcessorABC):
    ...
    def __init__(self, year, xsec, corrections, ids, common):
        ...
        self._columns = """                                                                                                                    
        AK15PFPuppi_Subjet_eta
        AK15PFPuppi_Subjet_mass
        AK15PFPuppi_Subjet_phi
        AK15PFPuppi_Subjet_pt
        AK15PFPuppi_Jet_eta
        AK15PFPuppi_Jet_jetId
        AK15PFPuppi_Jet_msoftdrop
        AK15PFPuppi_Jet_phi
        AK15PFPuppi_Jet_particleNetAK15_QCDb
        AK15PFPuppi_Jet_particleNetAK15_QCDbb
        AK15PFPuppi_Jet_particleNetAK15_QCDc
        AK15PFPuppi_Jet_particleNetAK15_QCDcc
        AK15PFPuppi_Jet_particleNetAK15_QCDothers
        AK15PFPuppi_Jet_particleNetAK15_Zbb
        AK15PFPuppi_Jet_pt
        AK15PFPuppi_Jet_subJetIdx1
        AK15PFPuppi_Jet_subJetIdx2
        CaloMET_pt
        CaloMET_phi
        Electron_charge
        Electron_cutBased
        ...
        self._samples = {
            'sr':('ZJets','WJets','DY','TT','ST','WW','WZ','ZZ','QCD','HToBB','HTobb','MET','Mhs_50','Mhs_70','Mhs_90','Vector_MonoTop'),
    ...
    def process(self, events):
        ...
        for region, cuts in regions.items():
            ...
            if isData:
                ...
                hout['templateH'].fill(dataset=dataset,
                                      region=region,
                                      systematic='nominal',
                ...
                if 'WJets' in dataset or 'ZJets' in dataset or 'DY' in dataset or 'GJets' in dataset or 'Z1' in dataset or 'Z2' in dataset :
                    if not isFilled:
                    ...
                    for systematic in systematics:
                        ...
                        hout['templateH'].fill(dataset='HF--'+dataset,
                                              region=region,
                                              systematic=sname,
                                              gentype=vgentype,
                                              recoil=u[region].mag,
                        ...
                        hout['templateH'].fill(dataset='LF--'+dataset,
                                              region=region,
                                              systematic=sname,
                                              gentype=vgentype,
                                              recoil=u[region].mag,
...
if __name__ == '__main__':
    ...
    with open('metadata/UL_TEST.json') as fin:
    ...
    save(processor_instance, 'data/had_monotop'+options.year+'.processor')
