...
ele_trig_hists_postVFP = {
    '2016': uproot3.open("data/trigger_eff_UL/UL_SingleElectron/egammaEffi.txt_EGM2D-2016postVFP.root")['EGamma_SF2D'],
    '2017': uproot3.open("data/trigger_eff_UL/UL_SingleElectron/egammaEffi.txt_EGM2D-2017.root")['EGamma_SF2D'],#monojet measurement for the combined trigger path
    '2018': uproot3.open("data/trigger_eff_UL/UL_SingleElectron/egammaEffi.txt_EGM2D-2018.root")['EGamma_SF2D'] #approved by egamma group: https://indico.cern.ch/event/924522/
}
get_ele_trig_weight_postVFP = {}
for year in ['2016','2017','2018']:
    ele_trig_hist = ele_trig_hists_postVFP[year]
    get_ele_trig_weight_postVFP[year] = lookup_tools.dense_lookup.dense_lookup(ele_trig_hist.values, ele_trig_hist.edges)
    

get_ele_trig_err_postVFP = {}
for year in ['2016','2017','2018']:
    ele_trig_hist = ele_trig_hists_postVFP[year]
    get_ele_trig_err_postVFP[year] = lookup_tools.dense_lookup.dense_lookup(ele_trig_hist.variances ** 0.5, ele_trig_hist.edges)
...
mu_trig_hists_preVFP = {
    '2016': uproot3.open("data/trigger_eff_UL/UL_SingleMuon/2016_preVFP/Efficiencies_muon_generalTracks_Z_Run2016_UL_HIPM_SingleMuonTriggers.root")['NUM_IsoMu24_or_IsoTkMu24_DEN_CutBasedIdTight_and_PFIsoTight_abseta_pt'],
    '2017': uproot3.open("data/trigger_eff_UL/UL_SingleMuon/2017/Efficiencies_muon_generalTracks_Z_Run2017_UL_SingleMuonTriggers.root")['NUM_IsoMu27_DEN_CutBasedIdTight_and_PFIsoTight_abseta_pt'],
    '2018': uproot3.open("data/trigger_eff_UL/UL_SingleMuon/2018/Efficiencies_muon_generalTracks_Z_Run2018_UL_SingleMuonTriggers.root")['NUM_IsoMu24_DEN_CutBasedIdTight_and_PFIsoTight_abseta_pt']
}
...
mu_trig_hists_postVFP = {
    '2016': uproot3.open("data/trigger_eff_UL/UL_SingleMuon/2016_postVFP/Efficiencies_muon_generalTracks_Z_Run2016_UL_SingleMuonTriggers.root")['NUM_IsoMu24_or_IsoTkMu24_DEN_CutBasedIdTight_and_PFIsoTight_abseta_pt'],
    '2017': uproot3.open("data/trigger_eff_UL/UL_SingleMuon/2017/Efficiencies_muon_generalTracks_Z_Run2017_UL_SingleMuonTriggers.root")['NUM_IsoMu27_DEN_CutBasedIdTight_and_PFIsoTight_abseta_pt'],
    '2018': uproot3.open("data/trigger_eff_UL/UL_SingleMuon/2018/Efficiencies_muon_generalTracks_Z_Run2018_UL_SingleMuonTriggers.root")['NUM_IsoMu24_DEN_CutBasedIdTight_and_PFIsoTight_abseta_pt']
}
...
for year in ['2016','2017','2018']:
    ...
    get_ele_reco_err_preVFP_above20[year]=lookup_tools.dense_lookup.dense_lookup(ele_reco_hist.variances ** 0.5, ele_reco_hist.edges)
...
for year in ['2016','2018', '2017']:
    get_mu_tight_id_err_postVFP[year] = lookup_tools.dense_lookup.dense_lookup(mu_tight_hist_postVFP[year].variances ** 0.5, mu_tight_hist_preVFP[year].edges)
    get_mu_loose_id_err_postVFP[year] = lookup_tools.dense_lookup.dense_lookup(mu_loose_hist_postVFP[year].variances ** 0.5, mu_loose_hist_preVFP[year].edges)
###
# Muon isolation SFs
###
...
#            files = {
#                'deepflav': {
#                    '2016': 'wp_deepJet_106XUL16postVFP_v2.csv',
#                    '2017': 'wp_deepJet_106XUL17_v3.csv',
#                    '2018': 'wp_deepJet_106XUL18_v2.csv'
#                },
#                'deepcsv': {
#                     '2016': 'wp_deepCSV_106XUL16postVFP_v2.csv',
#                     '2017': 'wp_deepCSV_106XUL17_v3.csv',
#                     '2018': 'wp_deepCSV_106XUL18_v2.csv'
#                }
#            }
...
class BTagCorrectorPostVFP:
    ...
    def __init__(self, tagger, year, workingpoint):
        ...
        files = {
           'deepflav': {
               '2016': 'wp_deepJet_106XUL16postVFP_v3.csv',
               '2017': 'wp_deepJet_106XUL17_v3.csv',
               '2018': 'wp_deepJet_106XUL18_v2.csv'
           },
           'deepcsv': {
                '2016': 'wp_deepCSV_106XUL16postVFP_v3.csv',
                '2017': 'wp_deepCSV_106XUL17_v3.csv',
                '2018': 'wp_deepCSV_106XUL18_v2.csv'
           }
        }
...
#     'get_ele_trig_err':get_ele_trig_err,
    ...
    'get_mu_trig_err_preVFP':get_mu_trig_err_preVFP,
    ...
    'get_ele_trig_weight_postVFP':get_ele_trig_weight_postVFP,
    'get_ele_trig_err_postVFP':get_ele_trig_err_postVFP,
    
}
save(corrections, 'data/corrections_r.coffea')
