...
if options.tar:
    ...
    os.system('tar --exclude-caches-all --exclude-vcs -czvf ../../decaf.tgz --exclude=\'analysis/hists/*/*.futures\'  --exclude=\'analysis/hists/*/*.merged\' --exclude=\'analysis/hists/*/*.reduced\' --exclude=\'Rishabh_jupyter-NB/*\' --exclude=\'Rishabh_NB\'  --exclude=\'analysis/hists/*/*____*\' --exclude=\'analysis/metadata/nanolist/new_UL2018/*\' --exclude=\'analysis/hists/*/*condor/*/*\' ../../decaf')
